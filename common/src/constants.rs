...
pub const NEARBY_RADIUS: f32 = 8.0;
pub const RESTAURANT_SUCCESS_PROBABILITY: f32 = 0.999; //0.9
pub const DELIVERY_SUCCESS_PROBABILITY: f32 = 0.99; //0.9
...
pub const PAYMENT_SUCCESS_PROBABILITY: f32 = 0.99; //0.7
