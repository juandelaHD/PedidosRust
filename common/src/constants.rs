...
pub const RESTAURANT_SUCCESS_PROBABILITY: f32 = 0.99999; //0.9
pub const DELIVERY_SUCCESS_PROBABILITY: f32 = 0.9999; //0.9
...
pub const PAYMENT_SUCCESS_PROBABILITY: f32 = 0.9999; //0.7
pub const INTERVAL_HEARTBEAT: Duration = Duration::from_secs(6);
pub const INTERVAL_STORAGE: Duration = Duration::from_secs(1);
...
pub const DEFAULT_TIME_TO_COOK: u64 = 8; // Default time in seconds
