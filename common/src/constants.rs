...
pub const INTERVAL_STORAGE: Duration = Duration::from_secs(4);
pub const TIMEOUT_HEARTBEAT: Duration = Duration::from_secs(6);
pub const TIMEOUT_LEADER_RESPONSE: Duration = Duration::from_secs(8);
